...
async def test_read_user_by_id_not_found(
    ...
    mock_user_service.get_by_id = AsyncMock(side_effect=NotFoundError(message="User not found"))
...
async def test_delete_user_by_id_not_found(
    ...
    mock_user_service.delete = AsyncMock(side_effect=NotFoundError(message="User not found"))
